...
class AllowanceDiscountDetailViewTests(SetUpPreMixin):

    def test_allowance_discount_detail_view_not_logged_in(self):
        item = mommy.make('atelier.AllowanceDiscount')
    ...
    def test_allowance_discount_detail_view(self):
        ...
        instance = mommy.make('atelier.AllowanceDiscount', **kwargs)
...
class AllowanceDiscountCreateViewTests(SetUpPreMixin):
...
class AllowanceDiscountEditViewTests(SetUpPreMixin):

    def test_allowance_discount_edit_view_not_logged_in(self):
        instance = mommy.make('atelier.AllowanceDiscount')
    ...
    def test_allowance_discount_edit_view_superuser(self):
        self.client.login(username='superuser', password='supassword')
        instance = mommy.make('atelier.AllowanceDiscount', name='Name')
        ...
        self.assertEqual(AllowanceDiscount.objects.get(id=instance.id).coefficient, 1.00)
        self.assertEqual(AllowanceDiscount.objects.get(id=instance.id).label, 'SomeLabel')
        self.assertEqual(AllowanceDiscount.objects.get(id=instance.id).last_updated_by, self.superuser)


class AllowanceDiscountDeleteViewTests(SetUpPreMixin):
...
class AllowanceDiscountListViewTests(SetUpPreMixin):
    ...
    def test_allowance_discount_list_pagination_is_ten(self):
        self.client.login(username='user', password='userpassword')
        self.allowance_discount = mommy.make('atelier.AllowanceDiscount', _quantity=13)
    ...
    def test_allowance_discount_list_all_elements(self):
        ...
        self.client.login(username='user', password='userpassword')
        self.allowance_discount = mommy.make('atelier.AllowanceDiscount',
                                             _quantity=13)
