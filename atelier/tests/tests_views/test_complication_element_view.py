...
class ComplicationElementViewTests(SetUpPreMixin):

    def test_complication_element_detail_view_not_logged_in(self):
        item = mommy.make(ComplicationElement)
    ...
    def test_complication_element_detail_view_user(self):
        ...
        instance = mommy.make(ComplicationElement, **kwargs)
        response = self.client.get('/en/atelier/complication_element/{}/'.format(instance.id))  # get response in way one
    ...
    def test_complication_element_edit_view_not_logged_in(self):
        instance = mommy.make(ComplicationElement)
        response = self.client.post(reverse_lazy('atelier:complication_element_update_form', kwargs={'pk': instance.id}))
        self.assertEqual(response.status_code, 404)
    ...
    def test_complication_element_edit_view_superuser(self):
        self.client.login(username='superuser', password='supassword')
        instance = mommy.make(ComplicationElement, name='Name')
    ...
    def test_complication_element_list_pagination_is_ten(self):
        self.client.login(username='user', password='userpassword')
        self.allowance_discount = mommy.make(ComplicationElement, _quantity=13)
    ...
    def test_complication_element_list_all_elements(self):
        ...
        self.client.login(username='user', password='userpassword')
        self.allowance_discount = mommy.make(ComplicationElement,
                                             _quantity=13)
