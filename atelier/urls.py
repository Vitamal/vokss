...
urlpatterns = [
    ...
    path('allowance_discount/<int:pk>/edit/', views.AllowanceDiscountUpdateView.as_view(), name='allowance_discount_update_form'),
    path('allowance_discount/<int:pk>/delete/', views.AllowanceDiscountDeleteView.as_view(), name='allowance_discount_delete_form'),
    path('complication_element/', views.ComplicationElementListView.as_view(), name='complication_element_list'),
    path('complication_element/<int:pk>/', views.ComplicationElementDetailView.as_view(), name='complication_element_detail'),
    path('complication_element/add/', views.ComplicationElementCreateView.as_view(), name='complication_element_form'),
    path('complication_element/<int:pk>/edit/', views.ComplicationElementUpdateView.as_view(), name='complication_element_update_form'),
    path('complication_element/<int:pk>/delete/', views.ComplicationElementDeleteView.as_view(), name='complication_element_delete_form'),
